          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Tabel Jadwal Tugas <small>Daftar tugas</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <a href="#" class="btn btn-success"><label class="fa fa-plus-circle"></label>  Tambah jadwal tugas</a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="tabel-pengguna" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th align="center">Deskripsi Tugas</th>
                          <th align="center">Sejak</th>
                          <th align="center">Dikumpul pada</th>
                          <th align="center">Media Pengumpulan</th>
                        </tr>
                      </thead>
